...
const (
	...
	ErrorReason_USER_UNAUTHORIZED        ErrorReason = 3
	ErrorReason_USER_FORBIDDEN           ErrorReason = 4
)
...
const file_user_v1_error_reason_proto_rawDesc = "" +
	"\n" +
	"\x1auser/v1/error_reason.proto\x12\auser.v1*\x85\x01\n" +
	"\vErrorReason\x12\x1c\n" +
	"\x18ERROR_REASON_UNSPECIFIED\x10\x00\x12\x12\n" +
	"\x0eUSER_NOT_FOUND\x10\x01\x12\x19\n" +
	"\x15USER_INVALID_ARGUMENT\x10\x02\x12\x15\n" +
	"\x11USER_UNAUTHORIZED\x10\x03\x12\x12\n" +
	"\x0eUSER_FORBIDDEN\x10\x04BW\n" +
	"\x18io.grpc.examples.user.v1B\x14UserErrorReasonProtoP\x01Z#shunfeng-miniprogram/api/user/v1;v1b\x06proto3"
