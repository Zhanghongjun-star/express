...
const (
	...
	ErrorReason_ORDER_EXPORT_FORBIDDEN     ErrorReason = 4
)
...
const file_order_v1_error_reason_proto_rawDesc = "" +
	"\n" +
	"\x1border/v1/error_reason.proto\x12\border.v1*\x98\x01\n" +
	"\vErrorReason\x12\x1c\n" +
	"\x18ERROR_REASON_UNSPECIFIED\x10\x00\x12\x13\n" +
	"\x0fORDER_NOT_FOUND\x10\x01\x12\x1a\n" +
	"\x16ORDER_INVALID_ARGUMENT\x10\x02\x12\x1e\n" +
	"\x1aORDER_QUERY_LIMIT_EXCEEDED\x10\x03\x12\x1a\n" +
	"\x16ORDER_EXPORT_FORBIDDEN\x10\x04BZ\n" +
	"\x19io.grpc.examples.order.v1B\x15OrderErrorReasonProtoP\x01Z$shunfeng-miniprogram/api/order/v1;v1b\x06proto3"
