...
func wireApp(confServer *conf.Server, confData *conf.Data, logger *slog.Logger, registrar registry.Registrar) (*kratos.App, func(), error) {
	...
	grpcServer := server.NewGRPCServer(confServer, todoService, userService, addressService, orderService, shippingService, freightService, authService)
	httpServer := server.NewHTTPServer(confServer, todoService, userService, addressService, orderService, shippingService, freightService, authService)
