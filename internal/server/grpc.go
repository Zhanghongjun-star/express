...
func NewGRPCServer(c *conf.Server, todo *service.TodoService, user *service.UserService, address *service.AddressService, order *service.OrderService, shipping *service.ShippingService, freight *service.FreightService, auth *service.AuthService, expressOrder *service.ExpressOrderService, packagingMaterial *service.PackagingMaterialService) *grpc.Server {
	...
	orderv3.RegisterPackagingMaterialServiceServer(srv, packagingMaterial)
	if address != nil {
