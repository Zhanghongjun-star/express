...
func NewGRPCServer(c *conf.Server, todo *service.TodoService, user *service.UserService, address *service.AddressService, order *service.OrderService,freight *service.FreightService,auth *service.AuthService) *grpc.Server {
